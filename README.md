...
- 基于路径追踪（path tracing）算法的[积分器](cpu_version/src/rendering/integrators/path.h)，包括：
...
- 内置了一些电介质材质的[折射率（refractive index）](cpu_version/src/rendering/ray.h#L9)，在配置文件中可根据名称直接调用
