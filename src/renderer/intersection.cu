...
// QUALIFIER_DEVICE Intersection::Intersection(const uint32_t id_instance, const float distance)
...
// QUALIFIER_DEVICE Intersection::Intersection(const uint32_t id_instance,
//                                             const bool inside,
//                                             const Vec2 &texcoord,
//                                             const Vec3 &pos,
//                                             const Vec3 &normal,
