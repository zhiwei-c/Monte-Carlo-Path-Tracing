...
QUALIFIER_D_H Vec2 operator+(const Vec2 &v1, const Vec2 &v2) { return {v1.u + v2.u, v1.v + v2.v}; }
...
QUALIFIER_D_H Vec2 operator+(const Vec2 &vec, const float t) { return {vec.u + t, vec.v + t}; }
...
QUALIFIER_D_H Vec2 operator+(const float t, const Vec2 &vec) { return {t + vec.u, t + vec.v}; }
...
QUALIFIER_D_H float Dot(const Vec2 &v1, const Vec2 &v2) { return v1.u * v2.u + v1.v * v2.v; }
